...
_Last updated: 2026-08-19 · Status: Phases 1–9 complete; 417 tests passing._
...
├── tests/                # 417 tests, including the manifest and verdict size bounds
...
Last verified run: **417 passed** on Python 3.14.6. `pip check`, `compileall`,

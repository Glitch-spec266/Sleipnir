...
_Last updated: 2026-08-19 · Status: Phases 1–9 complete; 415 tests passing._
...
├── tests/                # 415 tests, including the manifest and verdict size bounds
...
Last verified run: **415 passed** on Python 3.14.6. `pip check`, `compileall`,

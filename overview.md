...
_Last updated: 2026-08-19 · Status: Phases 1–9 complete; 414 tests passing._
...
├── tests/                # 414 tests, including the manifest and verdict size bounds
...
Last verified run: **414 passed** on Python 3.14.6. `pip check`, `compileall`,

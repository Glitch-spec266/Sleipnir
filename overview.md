...
_Last updated: 2026-08-19 · Status: Phases 1–9 complete; 412 tests passing._
...
├── tests/                # 412 tests, including the manifest and verdict size bounds
...
Last verified run: **412 passed** on Python 3.14.6. `pip check`, `compileall`,

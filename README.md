...
## Status: Phase 1 (schema) — awaiting review

| Phase | Scope | State |
|---|---|---|
| 1 | state schema + design | **complete, under review** |
| 2 | executor + adapters (`claude`, `codex`, `openrouter`) | not started |
...
tests/test_schema.py        48 tests, including the executable form of the
                            manifest size bound
```
